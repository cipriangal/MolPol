...
MolPolMessenger::MolPolMessenger(){
    ...
    fRemollDir = new G4UIdirectory("/MolPol/");
    ...
    seedCmd->SetParameterName("seed", false);
		...
		//fStandModeCmd = new G4UIcmdWithAnInteger("/MolPol/fStandMode",this);
		//fStandModeCmd->SetGuidance("Set fStandMode to an option");
		//fStandModeCmd->SetParameterName("standmode", false);
		
		fDetModeCmd = new G4UIcmdWithAnInteger("/MolPol/fDetMode",this);
...
//    fPhiCmd = new G4UIcmdWithADoubleAndUnit("/MolPol/phi", this);
//    fPhiCmd->SetGuidance("Set particle phi");
//    fPhiCmd->SetParameterName("phi", false);

    fZCmd = new G4UIcmdWithADoubleAndUnit("/MolPol/z", this);
